...
export default function CreateArticle() {
  ...
  const addTag = () => {
    if (newTag.trim() && !tags.includes(newTag.trim())) {
      setTags([
        ...tags,
        newTag.trim().startsWith("#") ? newTag.trim() : `#${newTag.trim()}`,
      ]);
      setNewTag("");
    }
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <Navigation />
      <div
        className={`relative h-15 flex items-center justify-center ${isMod ? "bg-gradient-to-r from-orange-500 to-yellow-500" : "bg-gradient-to-b from-blue-600 to-blue-800"}`}
      >
            ...
            <div className="p-8 bg-white rounded-lg border border-gray-300 shadow-sm flex flex-col gap-5">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3 mb-2">
                    {tags.map((tag, index) => (
                      <div
                        key={index}
                        className="flex items-center bg-gray-200 text-gray-700 px-3 py-1.5 rounded-md text-sm font-medium border border-gray-300"
                      >
                        <button
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      getUserRole() === "moderator" ? "/moderator" : "/admin",
                    )
                  }
